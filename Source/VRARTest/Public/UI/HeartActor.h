...
//This enum defines the different states that the heartactor can be in
UENUM(BlueprintType)
...
public:	
	...
	// Defining all the meshes for allocation in the blueprint
	...
	//This will set the model of the heartActor based on the input EHeartFillState.
