...
protected:
	...
	// OnColliderOverlap() funciton is called when the vr player overlaps with the boxCollider, if the powerup has not already been claimed it will add a powerUp to the character
	// and then set itself to uncollidable and invisible.
	UFUNCTION()
